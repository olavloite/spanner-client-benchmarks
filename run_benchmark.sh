...
if [ "$SPANNER_ENABLE_CHANNEL_POOL" = "true" ] || [ "$SPANNER_ENABLE_CHANNEL_POOL" = "1" ] || [ "$SPANNER_ENABLE_CHANNEL_POOL" = "yes" ]; then
  ENV_FLAGS="${ENV_FLAGS},SPANNER_ENABLE_CHANNEL_POOL=true"
fi
if [ "$SPANNER_ENABLE_DYNAMIC_CHANNEL_POOL" = "true" ] || [ "$SPANNER_ENABLE_DYNAMIC_CHANNEL_POOL" = "1" ] || [ "$SPANNER_ENABLE_DYNAMIC_CHANNEL_POOL" = "yes" ]; then
  ENV_FLAGS="${ENV_FLAGS},SPANNER_ENABLE_DYNAMIC_CHANNEL_POOL=true"
fi
if [ "$GOOGLE_SPANNER_ENABLE_DIRECT_ACCESS" = "true" ] || [ "$GOOGLE_SPANNER_ENABLE_DIRECT_ACCESS" = "1" ] || [ "$GOOGLE_SPANNER_ENABLE_DIRECT_ACCESS" = "yes" ]; then
  ENV_FLAGS="${ENV_FLAGS},GOOGLE_SPANNER_ENABLE_DIRECT_ACCESS=true"
fi
